...
from .frame_funcs import get_padded_roi_from_frame
from .matplotlib_funcs import fig2cv2
...
def add_text_to_frame(frame, text,
    ...
    for line in text.splitlines():
        ...
        cv2.putText(frame, line, line_org,
...
def apply_functions_to_frame(frame, frame_functions=None, *args, **kwargs):
    """
    Applies a list of functions to a frame. The functions can be either static or dynamic. If they are dynamic, they
    are expected to be functions that take the frame as input and return the modified frame.
